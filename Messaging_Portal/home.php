...
<head>
	...
	<title>Welcome to Messaging Portal</title>
...
<body class="d-flex justify-content-center align-items-center vh-100" style="background-color: rgb(168 162 158);">
    <div class="p-2 w-400 rounded shadow" style="background-color: white;">
    	<div>
    		<div class="d-flex mb-3 p-3 bg-light justify-content-between align-items-center">
    			<div class="d-flex align-items-center">
    			    <img src="uploads/<?=$user['prof_phote']?>" class="w-25 rounded-circle">
	    			...
	    			<li class="list-group-item">
	    				<a href="chat.php?user=<?=$conversation['email']?>"
	    				   class="d-flex justify-content-between align-items-center p-2">
	    					<div class="d-flex align-items-center">
	    					    <img src="uploads/<?=$conversation['prof_phote']?>" class="w-10 rounded-circle">
